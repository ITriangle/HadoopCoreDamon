...
//        Dataset<Row> df = spark.read().json("/home/wl/Work/TestMeasure/src/data/people.json");

        String filePath = "file:///home/wl/WLWork/hadoop-spark/SparkByJava/data/people.json"; // Should be some file on your system
